...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        IdentificacaoJogador id1 = new IdentificacaoJogador("Quaresma", 25, PosicaoNoCampo.MEDIO);
        Jogador j1 = new Jogador(h1, id1);
        // J2 Casilhas
        AtributosRedes h2 = new AtributosRedes(5, 7, 10, 4, 6, 8, 1, 5);
        IdentificacaoJogador id2 = new IdentificacaoJogador("Casilhas", 32, PosicaoNoCampo.GUARDA_REDES);
        Jogador j2 = new Jogador(h2, id2);
        // J3 Ronaldo
        AtributosAvanacado h3 = new AtributosAvanacado(5, 7, 10, 4, 6, 8, 1);
        IdentificacaoJogador id3 = new IdentificacaoJogador("Ronaldo", 32, PosicaoNoCampo.AVANCADO);
        Jogador j3 = new Jogador(h3, id3);
        // J4 Messi
        AtributosAvanacado h4 = new AtributosAvanacado(5, 7, 10, 4, 6, 8, 1);
        IdentificacaoJogador id4 = new IdentificacaoJogador("Messi", 32, PosicaoNoCampo.AVANCADO);
        Jogador j4 = new Jogador(h4, id4);
        // J5 Neymar
        AtributosLateral h5 = new AtributosLateral(5, 7, 10, 4, 6, 8, 1);
        IdentificacaoJogador id5 = new IdentificacaoJogador("Neymar", 32, PosicaoNoCampo.LATERAL);
        Jogador j5 = new Jogador(h5, id5);
        // J6 Defesas
        AtributosDefesa h6 = new AtributosDefesa(5, 7, 10, 4, 6, 8, 1);
        IdentificacaoJogador id6 = new IdentificacaoJogador("Daniel Xavier", 32, PosicaoNoCampo.DEFESA);
